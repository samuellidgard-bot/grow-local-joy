...
- The CRM Overview should behave as the main operating hub, not just an outreach dashboard: client progress, next actions and system health appear before the outreach/pipeline snapshot.
