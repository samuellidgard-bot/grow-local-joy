...
5. Sam reviews the current post markdown file.
6. Only post drafts scoring `45/60` or higher on the QA scorecard.
7. Build the visual in Canva, CapCut or Instagram drafts.
8. Post manually.
